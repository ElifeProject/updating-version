    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(img/8.jpg);"></div>
                    ...
                    <div class="row h-100 align-items-center font-cursive">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center">
                                ...
                                <p>Books are the part of Universe. Even Internet is not the replacement of the pure delight one can have with Books in hands and a cup of tea. E-Life will provide you all the technical and non-technical books in hardcopy so that you will learn and enjoy at the same time.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <a href="Books_Engineering.php">
                        <img src="img/11.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Engineering Books</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="Books_non_Engineering.php">
                        <img src="img/10.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Non-Engineering Books</h3>
                    </a>
                </div>
            </div>
    </section>
