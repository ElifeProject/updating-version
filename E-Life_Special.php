...
<head>
    ...
    <!-- Title -->
    <title>E-Life|E-Life Special</title>
    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(img/bgspecial.jpg);"></div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center font-cursive">
                                ...
                                <p>Birthdays are the integral part of University Life. E-Life will provide you homemade cakes and cookies for the birthdays of your loved ones.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <a href="handmade_bags.php">
                        <img src="img/handmade.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Handmade Bags</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="handmade_covers.php">
                        <img src="img/mobilecover.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Mobile Covers</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="hmcakes.php">
                        <img src="img/handmadecake.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Homemade Cakes</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="hmcookies.php">
                        <img src="img/cookies.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Special Cookies</h3>
                    </a>
                </div>
            </div>
    </section>
