...
<head>
    ...
    <!-- Title -->
    <title>E-Life|Stationary Store</title>
    ...
    <section class="hero-area">
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                <!-- Post Image -->
                <div class="slide-img bg-img" style="background-image: url(img/stationary-bg.jpg);"></div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            ...
                            <div class="hero-slides-content text-center font-cursive">
                                ...
                                <p>Among the different types of products used in offices, stationery item is one of the most important elements required. Having the right stationary supplies is essential for the day to day running of your business. E-Life will provide all the neccessary items you need the most in daily routine task.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <a href="stationary&craft.php">
                        <img src="img/stationary.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Stationary & Crafts</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="artSupplies.php">
                        <img src="img/3.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Art Supplies</h3>
                    </a>
                </div>
            </div>
    </section>
