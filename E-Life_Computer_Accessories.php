...
<head>
    ...
    <!-- Title -->
    <title>E-Life|Computer Accessories</title>
        ...
        <div class="hero-post-slides owl-carousel">
            ...
            <div class="single-hero-post bg-overlay">
                ...
                <div class="container h-100">
                    <div class="row h-100 align-items-center font-cursive">
                        <div class="col-12">
                            <!-- Post Content -->
                            <div class="hero-slides-content text-center">
                                <h2>E-Life Computer Peripherals</h2>
                                <p>Computer Peripherals and Mobile Accessories are as important as mobile phones or Computers now a days. E-Life will provide you all the necessary equipments you need to run your computer successfully. </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <a href="Chargers.php">
                        <img src="img/charger.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Chargers</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="cover&cases.php">
                        <img src="img/images.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Cases & Covers</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="batteries.php">
                        <img src="img/battery.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Batteries</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="power_banks.php">
                        <img src="img/powerbank.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Power Banks</h3>
                    </a>
                </div>

                <div class="col-md-4 col-sm-12">
                    <a href="headset&handfrees.php">
                        <img src="img/earphone.jpg" class="img-size">
                        <br>
                        <h3 class="mt-10">Earphones & Headsets</h3>
                    </a>
                </div>
            </div>
    </section>
